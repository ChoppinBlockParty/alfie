...
def verify(backup):
    ...
    required = ('opt/alfie/docker-compose.alfie.yml', 'opt/alfie/data/config.yaml', 'images.json')
...
if __name__ == '__main__':
    ...
    print('PASS rollback backup readability and SQLite integrity', result)
